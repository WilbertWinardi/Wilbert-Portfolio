...
export const ProjectModal = ({ project, onClose }: ProjectModalProps) => {
  ...
  return (
    ...
    >
      <Card
        className="w-[calc(100%-2rem)] md:max-w-2xl lg:max-w-5xl h-[85vh] md:h-[90vh] !rounded-3xl relative flex flex-col overflow-hidden"
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] h-full gap-4">
          ...
          <div className="flex flex-col gap-6 pt-0 p-6 md:p-8 md:pt-0 lg:p-8 overflow-y-auto h-full scrollbar-thin-elegant">
            <div>
